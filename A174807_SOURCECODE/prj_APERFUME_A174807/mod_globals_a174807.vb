Module mod_globals_a174807
    Public username As String
    Public myconnection As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=DB_APERFUME_A174807.accdb;Persist Security Info=False;"
    ...
    Public Sub run_sql_command(thissql As String)
        ...
        Catch ex As Exception
            Beep()
            MsgBox("There is an error in the data you entered, as shown below: " & vbCrLf & vbCrLf & ex.Message)
